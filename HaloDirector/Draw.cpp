...
int GetTextWidth(char* szText, ID3DXFont* pFont)
{
	RECT rcRect = { 0,0,0,0 };
	if (pFont)
	{
...
void DrawLine(float x, float y, float xx, float yy, int r, int g, int b, int a, float px)
{
	D3DXVECTOR2 dLine[2];
	...
	dx_Line->Draw(dLine, 2, D3DCOLOR_RGBA(r, g, b, a));
